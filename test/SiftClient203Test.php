...
class SiftClient203Test extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->client = new SiftClient([
            "api_key" => SiftClient203Test::$API_KEY,
        ]);
    ...
    public function testSuccessfulScoreFetch(): void
    {
        ...
        $mockUrl =
            "https://api.sift.com/v203/score/12345?api_key=agreatsuccess";
        $mockResponse = new SiftResponse(
            '{"status": 0, "error_message": "OK",
                "user_id": "12345", "score": 0.55}',
            200,
            null
        );
    ...
    {
        $mockUrl =
            "https://api.sift.com/v203/users/54321/labels?api_key=agreatsuccess";
    ...
    {
        $mockUrl =
            "https://api.sift.com/v203/users/54321" .
            urlencode('=.-_+@:&^%!$') .
            "/labels";
        $mockResponse = new SiftResponse(
            '{"status": 0, "error_message": "OK"}',
